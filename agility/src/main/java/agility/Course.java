...
public enum Course {
    ...
    public static Course getNearest() {
        Player local = Players.INSTANCE.getLocal();
        if (local == null) {
            return null;
        }
